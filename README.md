...
- Laravel `11.x`
    - Tag - https://github.com/AnangSujatmoko/laravelrole/releases/tag/Laravel11.x

## Project Setup
Git clone -
```console
git clone https://github.com/AnangSujatmoko/laravelrole.git
```
...
## Wanna talk with me
Please mail me at - codeliner.id@gmail.com
